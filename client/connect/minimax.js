//The recursive minimax algorithm as described in the awesome video by Keith Galli (https://www.youtube.com/@KeithGalli).
//This works by looking at every next possible computer move followed by every next possible user move. The process is 
//repeated the number of times set by "depth" which is the same as "difficulty level." A heuristic scores the outcome 
//of each branch of this decision tree for both players, choosing a move with the best likely outcome for the computer. 
...
function minimax(board, depth, alpha, beta, maximizingPlayer){
    ...
    //the maximizing player scores the AI's best move
    ...
    //the minimizer player scores the User's best move
